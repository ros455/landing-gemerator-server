...
router.patch('/update-comment/:id',AdminCommentController.update);
router.patch('/update-image/:id',AdminCommentController.upload.single('imageUrl'),AdminCommentController.updateImage);
