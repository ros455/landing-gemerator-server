...
router.patch('/update-user-comment/:id',UserCommentController.update);

router.patch('/update-user-image/:id',UserCommentController.upload.single('imageUrl'),UserCommentController.updateImage);
